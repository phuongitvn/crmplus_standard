<?php /* Smarty version Smarty-3.1.7, created on 2014-02-16 15:19:20
         compiled from "/var/www/html/CRMPlus/crmplus_ga_standard/includes/runtime/../../layouts/vlayout/modules/Vtiger/MenuBar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16891185415300d6f8640f58-22082493%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '23f3848380b2428fb065ce04c92f3d7b81dade85' => 
    array (
      0 => '/var/www/html/CRMPlus/crmplus_ga_standard/includes/runtime/../../layouts/vlayout/modules/Vtiger/MenuBar.tpl',
      1 => 1392560531,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16891185415300d6f8640f58-22082493',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5300d6f890d6f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5300d6f890d6f')) {function content_5300d6f890d6f($_smarty_tpl) {?>
<?php $_smarty_tpl->tpl_vars["topMenus"] = new Smarty_variable($_smarty_tpl->tpl_vars['MENU_STRUCTURE']->value->getTop(), null, 0);?><?php $_smarty_tpl->tpl_vars["moreMenus"] = new Smarty_variable($_smarty_tpl->tpl_vars['MENU_STRUCTURE']->value->getMore(), null, 0);?><?php $_smarty_tpl->tpl_vars['NUMBER_OF_PARENT_TABS'] = new Smarty_variable(count(array_keys($_smarty_tpl->tpl_vars['moreMenus']->value)), null, 0);?><div class="navbar" id="topMenus"><div class="navbar-inner" id="nav-inner"><div class="menuBar row-fluid"><div class="span9" style="overflow: hidden;"><ul class="nav modulesList"><li class="tabs"><a class="alignMiddle logocrmplus" href="/"><img src="<?php echo vimage_path('home.png');?>
...
$_smarty_tpl->tpl_vars['obj']->_loop = true;
 $_smarty_tpl->tpl_vars['index']->value = $_smarty_tpl->tpl_vars['obj']->key;
?><?php if ($_smarty_tpl->tpl_vars['obj']->value->getLabel()==null){?><li class="divider">&nbsp;</li><?php }elseif($_smarty_tpl->tpl_vars['obj']->value->getLabel()=='LBL_FEEDBACK'){?><li><a href="http://thongtinquanly.com/crmplus" target="_blank"><?php echo vtranslate($_smarty_tpl->tpl_vars['obj']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
