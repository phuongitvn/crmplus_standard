...
class Vtiger_Record_Model extends Vtiger_Base_Model {
	...
	public static function getSearchResult($searchKey, $module=false) {
		...
		$query = 'SELECT c1.label, c1.crmid, c1.setype, c1.createdtime 
					FROM vtiger_crmentity c1
					LEFT JOIN vtiger_account c2 ON c1.crmid=c2.accountid
					WHERE (c1.label LIKE ? OR c2.phone LIKE ? OR c2.otherphone LIKE ?) AND c1.deleted = 0';
