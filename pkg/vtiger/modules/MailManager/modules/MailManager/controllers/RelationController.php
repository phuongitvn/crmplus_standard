 ...
 * All Rights Reserved.
 ************************************************************************************/
include_once dirname(__FILE__) . '/../../../include/Webservices/DescribeObject.php';
include_once dirname(__FILE__) . '/../../../include/Webservices/Query.php';
 ...
 */
class MailManager_RelationController_Controller extends MailManager_Controller_Controller {
		...
		if ('find' == $request->getOperationArg()) {
			...
			switch ($linkModule) {
				...
				case 'HelpDesk' :   $from = $mail->from();
									if($linkedto['module'] == 'Contacts') {
										$focus->column_fields['contact_id'] = $parent;
									} else if($linkedto['module'] == 'Accounts') {
										$focus->column_fields['parent_id'] = $parent;
									} else {
