 ...
 * All Rights Reserved.
 ************************************************************************************/
include_once 'modules/MailManager/controllers/Controller.php';
include_once 'modules/MailManager/models/Draft.php';

/**
 * Class that handles Internal vtiger Drafts
 */
class MailManager_DraftController_Controller extends MailManager_Controller_Controller {
